    ...
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-32 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
        <div className="reveal-up">
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row"><Link href="/shop" className="interactive-lift rounded-full bg-[#0b5f59] px-7 py-4 text-center font-semibold text-white shadow-xl shadow-teal-900/20">Shop frames</Link><Link href="/checkout" className="interactive-lift rounded-full border border-[#11263d]/25 bg-white px-7 py-4 text-center font-semibold text-[#11263d] hover:border-[#11263d]">Try payment flow</Link></div>
